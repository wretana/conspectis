<%@ Control Language="C#" ClassName="PrintablePieChart_ascx" %>
...
<script language="C#" runat="server">   
    ...
    {                
        ...
        {
            BackgroundBrush = new System.Drawing.Drawing2D.LinearGradientBrush( BackgroundRectangle, Color.FromArgb( 255, 255, 255 ), Color.FromArgb( 255, 255, 255 ), 0, false) ;
        }
        ...
        Font titleFont = new Font("Verdana", 10, FontStyle.Bold);
    ...
    private void drawLabels( Graphics g )
    {
        ...
        Font labelFont = new Font( "Verdana", 7, FontStyle.Bold );        
