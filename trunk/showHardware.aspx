...
//	Response.Write(showHw);
	...
	if (!IsPostBack)
	{
		...
		if (!emptyDataset(dat))
		{
			if (dat.Tables[0].Rows[0]["class"].ToString()=="BladeCenter H")
			{
				deviceName.InnerHtml=dcPrefix.ToUpper().Replace("_","")+" BladeCenter #"+dat.Tables[0].Rows[0]["bc"].ToString();
				sqlBc="SELECT * FROM (SELECT slot,class,serial,model FROM rackspace WHERE bc='"+dat.Tables[0].Rows[0]["bc"].ToString()+"') WHERE slot<>'00'";
				datBc=readDb(sqlBc);
				if (datBc!=null)
				{
					bool fill;
					...
					tr = new HtmlTableRow();    //Output <TR>
						...
						td = new HtmlTableCell(); //Output <TD>
							td.InnerHtml = "Class";
							td.Attributes.Add("style","width:5;");
						tr.Cells.Add(td);         //Output </TD>
						td = new HtmlTableCell(); //Output <TD>
							td.InnerHtml = "Model";
							td.Attributes.Add("style","width:5;");
...
//			Response.Write(sqlRack+"<BR/>");
			...
			hwBc.InnerHtml=dat.Tables[0].Rows[0]["bc"].ToString();
	...
	titleSpan.InnerHtml="Show Hardware";
}
</SCRIPT>
</HEAD>
...
<!--#include file='popup_opener.inc' -->
	<DIV id='popContent'>
		<DIV class='center altRowFill'>
			...
			<DIV class='italic' id='deviceName' runat='server' />
							...
							<TABLE>
								<TR>
									...
									<TD class='whiteRowFill left'>
										<DIV id='hwClass' runat='server'/>
									</TD>
								</TR>
								<TR>
									<TD class='inputform'>Model:</TD>
									<TD class='whiteRowFill left'>
										<DIV id='hwModel' runat='server'/>
									</TD>
								</TR>
								<TR>
									<TD class='inputform'>Serial:</TD>
									<TD class='whiteRowFill left'>
										<DIV id='hwSerial' runat='server'/>
									</TD>
								</TR>
								...
								<TR>
									...
									<TD class='whiteRowFill left'>
										<DIV id='hwRack' runat='server'/>
									</TD>
								</TR>
								<TR>
									<TD class='inputform'>&#xa0; &#xa0; BC:</TD>
									<TD class='whiteRowFill left'>
										<DIV id='hwBc' runat='server'/>
									</TD>
								</TR>
								<TR>
									<TD class='inputform'>&#xa0; &#xa0; 'U' Slot:</TD>
									<TD class='whiteRowFill left'>
										<DIV id='hwSlot' runat='server'/>
									</TD>
								</TR>
								<TR><TD class='inputform'>&#xa0;</TD><TD class='whiteRowFill left'>&#xa0;</TD></TR>
								<TR>
									...
									<TD class='whiteRowFill left'>
										<DIV id='hwReserved' runat='server'/>
									</TD>
								</TR>
								<TR>
									<TD class='inputform'>SAN Attached?</TD>
									<TD class='whiteRowFill left'>
										<DIV id='hwSANAttach' runat='server'/>
									</TD>
								</TR>
								<TR><TD class='inputform'>&#xa0;</TD><TD class='whiteRowFill left'>&#xa0;</TD></TR>
								<TR>
									...
									<TD class='whiteRowFill center'>
										<TABLE id='memberBlades' class='datatable' runat='server' />
									</TD>
								</TR>
								<TR><TD class='inputform'>&#xa0;</TD><TD class='whiteRowFill left'>&#xa0;</TD></TR>
								<TR>
									<TD class='inputform'>&#xa0;</TD>
									<TD class='whiteRowFill center'>
										<TABLE id='cableMap' class='datatable' runat='server' />
									</TD>
								</TR>
								<TR><TD class='inputform'>&#xa0;</TD><TD class='whiteRowFill left'>&#xa0;</TD></TR>
								<TR>
									<TD class='inputform'>&#xa0;</TD>
									<TD class='whiteRowFill center'>
										<TABLE id='entityTable' class='datatable' runat='server' />
									</TD>
								</TR>
							</TABLE>
						</TD>
