...
public void Page_Load(Object o, EventArgs e)
{
	...
	capacityMeta.InnerHtml="<B>Total Rackspace in NITC/KCDC:</B> "+rackTotal.ToString()+"<BR><BR><B>Occupied Rackspace in NITC/KCDC:</B> "+rackOccupied.ToString()+"<BR><BR><B>Available Rackspace in NITC/KCDC:</B> "+rackAvailable.ToString()+"<BR>&nbsp &nbsp <B>Available Blades:</B> "+rackFreeBlade.ToString()+"<BR>&nbsp &nbsp <B>Available xSeries:</B> "+rackFreeXseries.ToString()+"<BR>&nbsp &nbsp <B>Available pSeries/LPARs:</B> "+rackFreePseries.ToString();
