<!-  Written By Bjorn Stickler                -->
<!-  http://www.stickler.de/PieChart.aspx     -->

<%@ Control Language="C#" ClassName="ReportPieChart_ascx" %>
...
<script language="C#" runat="server">   
    ...
    public int BackgroundColor=0x78FFFFFF;
    public int BackgroundFrom=0;
    public int BackgroundTo=0;

    public Brush BackgroundBrush = null;
    public Brush TitleBrush = Brushes.Black;
	...
	if (BackgroundFrom==0)
	{
	    BackgroundFrom=BackgroundColor;
	}
	...
	if (BackgroundFrom==0)
	{
        ...
        {
            BackgroundBrush = new System.Drawing.Drawing2D.LinearGradientBrush( BackgroundRectangle, Color.FromArgb(BackgroundFrom), Color.FromArgb(BackgroundTo), 0, false) ;
        }
        ...
        Font titleFont = new Font("Verdana", Convert.ToInt32(ImageHeight*.057), FontStyle.Bold);
    ...
    {      
	PiePaddingTop = Convert.ToInt32(ImageHeight*.25);
	PiePaddingBottom = Convert.ToInt32(ImageHeight*.10);
	PiePaddingLeft = Convert.ToInt32(ImageWidth*.46);
	PiePaddingRight = Convert.ToInt32(ImageWidth*.10);
	PieHeight = Convert.ToInt32(ImageHeight*.15);
    ...
    private void drawLabels( Graphics g )
    {
        ...
        Font labelFont = new Font( "Verdana", Convert.ToInt32(ImageHeight*.043), FontStyle.Bold );        
