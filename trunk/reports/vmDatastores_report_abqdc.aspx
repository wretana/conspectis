...
void goVirtDetail(Object sender, EventArgs e)
{
	...
	Response.Write("<script language='javascript'>window.open('vmDatastoreDetail_report.aspx?cluster="+fromId.Substring(fromId.IndexOf("_")+1,fromId.Length-fromId.IndexOf("_")-1)+"','datastoreDetailWin','width=800,height=800,menubar=no,status=yes,scrollbars=yes')"+";<"+"/script>");
}
