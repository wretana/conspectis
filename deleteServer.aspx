...
//UNCOMMENT this line to force login to access this page.
	lockout(); Page.Header.Title=shortSysName+": Delete Server";
	systemStatus(1); // Check to see if admin has put system is in offline mode.

	string sql, sql1;
	DataSet dat, dat1;
	DateTime dateStamp = DateTime.Now;
	string v_username, errstr="", sqlErr="", srcHost="", dcPrefix="";
	...
	queryStr.InnerHtml=srcHost+" <SPAN class='italic'>("+dcPrefix.ToUpper().Replace("_","")+")</SPAN> ";
	if (IsPostBack)
	{
...
//					//  sendServerDeletionNotice(srcHost,v_username); // Erroring ...
	...
	titleSpan.InnerHtml="Delete Server";
}
</SCRIPT>
</HEAD>
